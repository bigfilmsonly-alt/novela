...
const FALLBACK: HostSegment = {
  greeting:
    "Welcome back to NOVELA. I'm your AI host, and tonight we have a stacked lineup.",
  recap:
    "This week on the platform: 'The Inheritance Game' just crossed 1 million views per episode — the fastest any NOVELA original has hit that mark. Meanwhile, Filmology Labs in Paterson just lit up soundstage 14 for a new thriller shot entirely on the LED volume wall.",
  trending:
  ...
  signoff:
    "That's your daily brief. 120 million episode views and counting. New episodes drop every evening. I'm your AI host — see you tomorrow night on NOVELA.",
};
  ...
  try {
    ...
    const message = await getAnthropic().messages.create({
      ...
      messages: [
        {
          role: "user",
          content: `You are the AI host of NOVELA, a vertical micro-drama platform (like E! Entertainment for the AI era). You deliver a daily 90-second show briefing — warm, knowledgeable, slightly dramatic.
...
- NOVELA Originals: "The Inheritance Game", "I Think My Wife Wants to Kill Me", "The Winter Veil", "The Dumb Billionaire", "Heiress In Love"
