...
const FALLBACK: HostSegment = {
  ...
  recap:
    "This week on the platform: 'The Inheritance Game' just crossed 1 million views per episode — the fastest any Versa TV original has hit that mark. Meanwhile, Meridian Studios in Paterson just lit up soundstage 14 for a new thriller shot entirely on the LED volume wall.",
  trending:
  ...
  recommendation:
    "If you haven't watched 'Nine Mile' yet, start there. It's a music drama set in Jamaica from the Legacy Sound Collective channel — think legacy, identity, and a studio that holds secrets. The cold opens alone are worth the swipe.",
  signoff:
...
- Celebrity-hosted channels (Legacy Sound Collective, Champion's Ring Studios, Nexus Wellness Labs)
- A Studio where users can create their own series with AI
- Meridian Studios: $250M production facility in Paterson, NJ — 21 soundstages, LED volume wall, 250,000 sq ft
